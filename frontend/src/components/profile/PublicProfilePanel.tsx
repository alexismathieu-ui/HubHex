...
import type { PublicProfileUser } from "../../types/hubhex";
...
export function PublicProfilePanel({ username }: PublicProfilePanelProps) {
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      setProfile(data.user as PublicProfileUser);
    } catch (error: unknown) {
